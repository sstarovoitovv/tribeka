...
Форма проверяет поля, согласие и содержимое файлов на PHP, сохраняет несколько `attachments[]`, использует атомарный flock rate limit. В релизе 09.09.2026 сбор статистики удалён по просьбе владельца: нет отправки событий, UTM-атрибуции и серверного коллектора. Утверждённый UI опубликован на основном домене. Новая редакция политики: 2026-09-08, согласие: 2026-09-04.
