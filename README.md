...
Форма проверяет поля, согласие и содержимое файлов на PHP, сохраняет несколько `attachments[]`, использует атомарный flock rate limit. В локальной ветке `design/ui-review` сбор статистики удалён по просьбе владельца: нет отправки событий, UTM-атрибуции и серверного коллектора. Прод этой правкой не обновлялся. Новая редакция политики в ветке: 2026-09-08, согласие: 2026-09-04.
