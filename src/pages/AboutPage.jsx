      ...
      <section className="bg-[#f7f7f5] py-14 sm:py-20">
        <div className="container-page grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-base leading-8 text-ink/70">Работаем с чертежами любой сложности. Результат соответствует техническому заданию заказчика — без необходимости самостоятельно координировать разных исполнителей и контролировать каждую промежуточную операцию</p>
          </div>
        </div>
      </section>
        ...
        <div className="container-page">
          <div className="relative min-h-[520px] overflow-hidden bg-white bg-contain bg-center bg-no-repeat px-7 py-10 sm:px-12 sm:py-14 lg:aspect-video lg:min-h-0 lg:px-16" style={{ backgroundImage: "url('/brand/tribeka-background.jpg')" }}>
            <div className="relative mt-24 max-w-xl border border-ink/10 bg-white p-7 sm:mt-28 sm:p-10">
              ...
              <p className="mt-5 text-sm leading-7 text-ink/70">Каждый проект рассчитывается индивидуально с учётом материала, геометрии и необходимых операций. Заказчик заранее понимает состав работ и получает честную стоимость без скрытых наценок</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-page grid gap-12 lg:grid-cols-[1fr_1.2fr] lg:items-center">
          ...
          <div className="grid gap-px bg-white/10 sm:grid-cols-2">
            {[
              ...
              <div key={label} className="bg-graphite p-6"><p className="text-[9px] font-bold uppercase tracking-widest text-white/75">{label}</p><p className="mt-3 text-lg font-black">{value}</p></div>
            ))}
          </div>
        </div>
      </section>
